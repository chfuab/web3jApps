...
public class PayService extends AsyncTaskLoader<Boolean> {
    private Web3j web3j;
    ...
    public PayService(@NonNull Context context, String contractAddress,
    ...
    public Boolean loadInBackground() {
        ...
        try {
            TransactionReceipt transactionReceipt = serviceContract.payService(serviceId).send();
        } catch (Exception e) {
            Log.d("FailedToPayService", e.toString());
        }
